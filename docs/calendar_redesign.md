...
第6フェーズでは、カレンダーをシンプルな自治体アプリUIに寄せて再整理した。月ヘッダー、前月/次月、今日ボタン、凡例、月表示グリッド、選択日詳細の順に情報を並べる。

日付セルは大きめにし、今日は緑の丸、選択日は緑の枠線、収集予定はアイコンと短いラベルで示す。セル内に詰め込みすぎず、詳細な分別名と出し方は選択日カードで確認する。
